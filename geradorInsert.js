module.exports.geraInsert = function (siapecad, siapecadPai, codUnidade,nome, sigla, siapecadGestora, 
    organizacional, orcamentaria, patrimonial, licitacoes, licitacoesEng, academica, metas, protocoloCentral, tipo, permiteGestao){
    let INSERT = `
--${nome}
INSERT INTO comum.unidade (
    ...
    nextval('comum.unidade_seq'), ${orcamentaria}, (SELECT ID_UNIDADE FROM COMUM.UNIDADE WHERE CODIGO_SIAPECAD = ${siapecadPai}), NULL, '${nome}', ${codUnidade}, '${sigla}',${tipo}, ${licitacoes}, ${licitacoesEng}, 1, NULL, NULL, '${nome}', ${patrimonial},
    ...
    false, 1, 2, NULL, 1, false, 16, true, false, NULL, NULL, NULL, ${siapecad}, NULL, 4, 1, '${nome}', NULL, 6575, ${metas}, NULL, NULL, true, '', '', 'PE', ${permiteGestao}, false, NULL, NULL, 4, NULL, NULL, false
);`;
    return INSERT;    
}
